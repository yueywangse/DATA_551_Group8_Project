...
We implemented feature engineering to derive temporal and spatial indicators, including rolling 7-day and 30-day counts, neighbourhood crime shares, monthly percentage changes, repeat block frequency, and time intervals between similar incidents, enhancing the analytical depth of the dashboard.
...
In future iterations, we plan to incorporate basic predictive components to explore potential future crime trends based on historical data.
